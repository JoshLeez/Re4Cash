    ...
    <HOC title="Re4Cash - Edukasi">
      ...
      <div className="artikel-kategori-tombol">
        ...
        <div className="two-btn-kategori">
          <button
            onClick={() => handleCategoryChange("Organik")}
            onDoubleClick={() => handleCategoryChange("")}
            className="organik"
            type="button"
          >
          ...
          <button
            onClick={() => handleCategoryChange("Anorganik")}
            onDoubleClick={() => handleCategoryChange("")}
            className="anorganik"
            type="button"
          >
        ...
        <p>
          Limbah padat lebih dikenal sebagai sampah. Menurut World Health
          Organization (WHO), sampah adalah barang yang berasal dari kegiatan
          manusia yang tidak lagi digunakan, baik tidak dipakai, tidak
          disenangi, ataupun yang dibuang. Terdapat beberapa jenis sampah
          berdasarkan senyawanya di bagi menjadi 2 yaitu organik dan anorganik
        </p>
      </div>
      <section className="artikel-list-search">
        ...
        <div className="all-list-artikel">
          {data
            .filter(
              (datas, index) =>
                (datas.kategori === selectedCategory ||
                  selectedCategory === "") &&
                datas.sub_kategori
                  .toLowerCase()
            ...
            .map((datas) => {
              ...
              const truncatedTitle =
                ...
                (datas.judul_artikel.length > maxLengthTitle ? "..." : "");
              return (
                <Artikelcard
                  key={datas.id_artikel}
