...
const AkunProfile = () => {
  ...
  const activeHandler2 = () =>{
    setActive({...active, active1: false,
      active2: true,
      active3: false,
      active4: false,})
  }
  ...
  const className1 = active.active1 ? "pesanan-saya-menu active" : "pesanan-saya-menu" 
  const className2 = active.active2 ? "pesanan-saya-menu active" : "pesanan-saya-menu" 
  const className3 = active.active3 ? "pesanan-saya-menu active" : "pesanan-saya-menu" 
            ...
            <section className="akun-profile-right-content">
              ...
              <section className="detail-pesanan-saya">
                <header className="pesanan-saya-navigation">
                  <div onClick={()=>{setPagination(0),  activeHandler1()}}  className={className1}>
                  ...
                  <div onClick={()=>{setPagination(-904), activeHandler2()}} className={className2}>
                    <iconify-icon icon="lucide:package-open"/>
                    <h3>Dikemas</h3>
                    <span className="circle-notification">3</span>
                  </div>
                  <div  onClick={()=>{setPagination(-1808), activeHandler3()}} className={className3}>
                    <iconify-icon icon="tabler:truck-delivery"/>
                    <h3>Dikirim</h3>
                  </div>
                  <div  onClick={()=>{setPagination(-2712), activeHandler4()}} className={className4}>
