          ...
          <div className="detail-content">
            ...
            <div className="wrapper-input">
              <div className="input-content">
                ...
                <input
                  type="text"
                  {...register("no_hp_pengelola", {required : true,
                    pattern: { value: /^(0|[1-9]\d*)(\.\d+)?$/}})}
                  placeholder="No. Hp Perusahaan/Toko/Perorangan "
                />
              </div>
              {errors.no_hp_pengelola && <span className="error-message">No HP Invalid atau </span>}
              {errors.nama_pengelola &&  <span className="error-message">Nama Perusahaan/Toko/Perorangan tidak boleh kosong</span>}
              <div className="input-content">
                <input
                ...
                />
                <input {...register("email_pengelola",{ pattern: {
                      value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,
                      message: "invalid email address",
                    }})} type="text" placeholder="Email Khusus (opsional)" />
              </div>
              {errors.no_rekening && <span className="error-message">Invalid No Rekening </span>}
              {errors.email_pengelola && <span className="error-message">atau Format Email Salah</span>}
            </div>
          </div>
          <div className="detail-content">
            <div className="subtitle">
            ...
            <textarea {...register("alamat_lengkap", {required : true})} placeholder="Alamat Lengkap (nama jalan dan patokan)" />
            {errors.alamat_lengkap && <span className="error-message">Alamat tidak boleh Kosong</span>}
            <div className="wrapper-input">
              <div className="input-content">
                <input
              ...
              {errors.kecamatan && 
                 <span className="error-message">Kecamatan tidak boleh Kosong </span>}
                  {errors.kabupaten_kota && 
                 <span className="error-message">atau Kabupaten tidak boleh Kosong</span>}
              <div className="input-content">
                <input
                ...
                />
                <input
                {...register("kode_pos", {required : true,    pattern: { value: /^(0|[1-9]\d*)(\.\d+)?$/ }})}
                  type="text"
                  placeholder="Kode Pos"
                />
              </div>
              {errors.provinsi && 
                 <span className="error-message">Provinsi tidak boleh Kosong atau </span>}
                 {errors.kode_pos && 
                 <span className="error-message">Kode Pos tidak boleh Kosong</span>}
            </div>
          </div>
          <p>
