              ...
              <form className="card-formtambah-dashpengelola-kelolalapakpenjualan">
                <div className="grup-formtambah-dashpengelola-kelolalapakpenjualan">
                  ...
                  <div className="baris-formtambah-dashpengelola-kelolalapakpenjualan">
                    ...
                    <input
                      type="text"
                      placeholder="Saya Mencari Minyak Jelantah Kiloan"
                    />
                  </div>
                  <div className="baris-formtambah-dashpengelola-kelolalapakpenjualan">
                    <label>
                    ...
                    <textarea
                      placeholder="Minyak jelantah adalah minyak bekas pemakaian, bisa dalam kebutuhan rumah tangga, kebutuhan restoran dan lain lain. Minyak ini meliputi minyak sawit dan segala minyak goreng lainnya.
...
Semua Orderan yang masuk sampai jam 5 sore, akan kami proses di hari yang sama. Selebihnya akan kami proses di hari berikutnya."
                    ></textarea>
                  </div>
                  <div className="baris-formtambah-dashpengelola-kelolalapakpenjualan">
                    <label>
