            ...
            <section className="wrapper-tabel-dashboard-kelolalapakpenjualan">
              <div className="judul-tabel-dashboard-kelolalapakpenjualan">
                ...
                <LinkButton
                  ...
                  to="/kelola-lapak-penjualan-pengelola/tambah"
                >
              ...
              <table id="tabel-pengelola-kelolalapakpenjualan">
                ...
                <tr>
                  ...
                  <td>
                    Pot Bunga Ramah Lingkungan merupakan Pot yang memiliki
                    fungsi Menanam Bunga mini yang pas untuk hiasan kamar anda
                  ...
                  <td>
                    <div className="tabel-kolom-aksibutton-detailedithapus">
                      ...
                      <LinkButton
                        type="AKSI_EDIT"
                        to="/kelola-lapak-penjualan-pengelola/edit"
                      >
                ...
                <tr>
                  ...
                  <td>
                    <div className="tabel-kolom-aksibutton-detailedithapus">
                      ...
                      <LinkButton
                        type="AKSI_EDIT"
                        to="/data-penjualan-pengelola/edit"
                      >
                        <iconify-icon icon="clarity:edit-solid" />
                      </LinkButton>
                      <Button tipe="AKSI_HAPUS">
