          ...
          <div className="wrapper-dashboard-utama">
            <section className="wrapper-tabel-dashboard-kelolalapakpenjualan">
                <div className="judul-tabel-dashboard-kelolalapakpenjualan">
                    ...
                    <LinkButton type="PRIMARY_LONG_GREEN" to="/kelola-lapak-pencarian-pengelola/tambah">
                ...
                <table id="tabel-pengelola-kelolalapakpenjualan">
                    ...
                    <tr>
                        ...
                        <td>Minyak jelantah adalah minyak bekas pemakaian, bisa dalam kebutuhan rumah tangga, kebutuhan restoran dan lain lain.</td>
                        <td>Rp15.000</td>
                        <td>Kg</td>
                        <td>Organik</td>
                        <td>Minyak</td>
                        ...
                        <td>
                            <div className="tabel-kolom-aksibutton-detailedithapus">
                                ...
                                <LinkButton type="AKSI_EDIT" to="/kelola-lapak-pencarian-pengelola/edit">
