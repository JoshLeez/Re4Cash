    ...
    <HOC title='Re4Cash | Kontak Kami'>
        <div className="kontakkami-banner">
            ...
            <div className='kontakkami-banner-content'>
                <h1>Kontak Kami</h1>
                <p>Mari Diskusikan Keluhan Anda Mengenai Website Kami, Bersama Kami Di Berbagai Kontak yang Tersedia Dibawah. Anda juga Memberikan/Meningalkan Pesan dan Kesan Anda dengan Mengisi Form Terlebih Dahulu Kemudian Tuliskan Komentar Kalian Di Card Paling Bawah (Pesan Anda). </p>
            </div>
        </div>
        <div className='kontakkami-content-container'>
            <div className="kontakkami-content-getintouch">
                <h1>Get in touch</h1>
                <p>Jika anda membutuhkan Informasi atau bantuan silahkan menggunakan kontak email dan tuliskan apa yang ingin anda tanyakan.</p>
            ...
            <div className="kontakkami-content-hubungikami">
                <h1>Hubungi Kami</h1>
                <p>Jika anda membutuhkan Informasi atau bantuan silahkan menggunakan kontak email atau nomor telepon yang tertera di bawah untuk menghubungi kami.</p>
                    ...
                    <div className="kantor-re4cash">
                        <h3>Kantor Re4Cash</h3>
                            ...
                            <div className='detail-kantor'>
                                ...
                                <p>Jl. Pembangunan 1, Selat Panjang Kota, Kec. Tebing Tinggi, Kabupaten Kepulauan Meranti, Riau</p>
                            </div>
                            <div className='detail-kantor'>
