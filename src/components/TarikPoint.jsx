...
const TarikPoint = () => {
  ...
  return (
    <section className="tarik-point-container">
      <div className="top-tarik-point">
        <div className="wrapper-detail-isi-nominal">
          <div className="detail-isi-nominal">
            ...
            <p>
              Harap tentukan jumlah uang yang ingin anda tarik untuk keperluan.
      ...
      <p>
        Proses pencaraian dana penarikan poin dilakukan selama dalam 48 jam jam
        kerja. Jika belum masuk ke rekening anda silahkan hubungi kami.
      </p>
    </section>
  );
};
