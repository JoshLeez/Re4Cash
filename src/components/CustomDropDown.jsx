...
const CustomDropDown = () => {
  ...
  return (
    <div className="custom-dd-container">
      <div
        role="select"
        defaultValue={"Kami Jemput"}
        aria-expanded={toggle}
        onClick={toggleHandler}
        className={toggle ? "dropdown-custom actived" : "dropdown-custom"}
      >
        {value}
        <UilAngleDown
      ...
      {toggle && (
        <div className="db-option-custom">
          <div data-value="Kami Jemput" onClick={(e) => DdValue(e)}>
            Kami Jemput
          </div>
          <div data-value="Antar Sendiri" onClick={(e) => DdValue(e)}>
            Antar Sendiri
          </div>
          <div data-value="Kurir" onClick={(e) => DdValue(e)}>
            Kurir
          </div>
        </div>
      )}
...
export const LongDropDown = (props) => {
  ...
  return (
    <div
      className={
        props.disable ? "custom-dd-container unactive" : "custom-dd-container"
      }
    >
      <div
        role="select"
        ...
        onClick={toggleHandler}
        className={
          toggle ? "long-dropdown-custom actived" : "long-dropdown-custom"
        }
      >
        {value}
        <UilAngleDown
      ...
      {toggle && (
        <div
          style={{ width: `${props.width}px` }}
          className="long-dd-option-custom"
        >
          {props.title && (
            <div data-value={props.title} onClick={(e) => DdValue(e)}>
              {props.title}
            </div>
          )}
          {props.title2 && (
            <div data-value={props.title2} onClick={(e) => DdValue(e)}>
              {props.title2}
            </div>
          )}
        </div>
...
export const DDTarikPoint = () => {
  ...
  return (
    <div className="custom-dd-tarik-point">
      <div
        className={
          toggle ? "tarik-point-dropdown active" : "tarik-point-dropdown"
        }
...
export const SecTarikPoint = () => {
  ...
  return (
    <div className="custom-dd-tarik-point-sec">
      <div
        className="tarik-point-dropdown-sec"
        onClick={() => setToggle(!toggle)}
      >
        <h3>Gerai</h3>
        <UilAngleDown
